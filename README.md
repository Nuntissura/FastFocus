...
$env:FF_ACTIVE_CAMERA_BRANDS = "sony,nikon,fujifilm,panasonic,olympus,om-system,canon"
...
Runs: docker db up -> migrate -> purge cameras -> import active datasheet brands (`FF_ACTIVE_CAMERA_BRANDS`, default `sony,nikon,fujifilm,panasonic,olympus,om-system,canon`) -> demo ingest -> match -> compute price bands -> compute deal scores -> API/SSR smoke requests.
